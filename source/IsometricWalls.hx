...
class IsometricWalls
{
  ...
  var tileMap:Array<Array<Int>> = [
    ...
    [16],             // E          (0b0010)
    [16],             // N, E       (0b0011)
    [16, 17, 18, 19], // S          (0b0100)
    [16, 17, 18, 19], // N, S       (0b0101)
    [16, 17, 18, 19], // S, E       (0b0110)
    [16, 17, 18, 19], // S, E, N    (0b0111)
    [16],             // W          (0b1000)
    [16],             // W, N       (0b1001)
    [16],             // W, E       (0b1010)
    [16],             // W, E, N    (0b1011)
    [16, 17, 18, 19], // W, S       (0b1100)
    [16, 17, 18, 19], // W, S, N    (0b1101)
    [16, 17, 18, 19], // W, S, E    (0b1110)
    [16, 17, 18, 19]  // N, E, S, W (0b1111)
  ];
